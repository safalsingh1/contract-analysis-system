...
def perform_search(question, limit=3):
    results = vec.search(question, limit=limit)
...
# Remove or comment out this line that's causing the error
# results = vec.search(relevant_question, limit=3)  # This line is causing the initialization error

# Now use the correct columns
# response, results = perform_search(relevant_question)
